...
BLOB_LIFE = 15              # life of blob in frames, if not seen
EDGE_THRESHOLD = 5         # border of image, in pixels, which is regarded as out-of-frame
...
MOVE_LIMIT = 50              # maximum velocity of the blob. If outside this limit, velocity is disabled
MATCH_DISTANCE = 60         # maximum distance between blobs in the Hungarian algorithm matching step
